...
def mode_selftest():
    ...
    if os.path.exists(c2n5):
        ...
        # The C2-NAV.5 bundle is historical evidence and is carried on the
        # diagnosis branch only; its reproduction check is skipped here.
        print('  skip  docs/data/c2nav5_bench.json not in this tree')
