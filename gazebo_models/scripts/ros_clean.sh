...
PATTERNS=(
  ...
  'cmd_vel_rela[y]'
  'cmd_vel_arbite[r]'
  # depth_cloud.launch.py's two image_pipeline nodes (nav.launch.py
  # depth_cloud:=true, C2-NAV.43); their command lines name neither launch file.
  'image_proc/resize_nod[e]'
